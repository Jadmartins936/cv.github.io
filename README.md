...
<body>
    <header>
        ...
        <figure>
            <img class="fig" src="figs/perfil.jpg" alt="Imagem de menina com roupas laranja olhando para o notebook" width="80" height="80">
            <figcaption>
                Imagem de perfil
            </figcaption>
        </figure>
    ...
    <main>
        <ul>
            <li>
                <span class="material-symbols-outlined">mail</span>Email: <a href="mailto:jadmartins936@gmail.com">jadmartins936@gmail.com</a>
            </li>
            <li>
                <span class="material-symbols-outlined">work</span>Linkedin: <a href="https://www.linkedin.com/in/jad-martins-ab2b75218?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">Perfil no Linkedin</a>
            </li>
            <li>
                <span class="material-symbols-outlined">location_on</span>Cornélio Procópio, Paraná
            </li>
        </ul>
        <h2>Resumo</h2>
        ...
        <h2>Educação</h2>
        <section>
            <p>Graduação em Análise de Sistemas (em andamento)</p>
            <p>UTFPR</p>
            <p>2024-2027</p>
        </section>
        <section>
